...
import { MapPin, Check, Trash2, Image } from 'lucide-react';
      ...
      <div className="container max-w-4xl py-6 md:py-8 px-4">
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="gallery-card text-center">
            ...
            <div className="text-sm text-muted-foreground">Museums Visited</div>
          </div>
          <div className="gallery-card text-center">
            <div className="font-display text-3xl font-bold text-accent mb-1">
              {completions.length}
            </div>
            <div className="text-sm text-muted-foreground">Artworks Seen</div>
          </div>
        </div>
