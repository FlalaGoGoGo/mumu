...
export function DistanceFilter({ maxDistance, onMaxDistanceChange, hasLocation }: DistanceFilterProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 sm:left-auto sm:right-0 mt-2 w-72 bg-popover border border-border rounded-lg shadow-lg z-50 overflow-hidden">
          {/* Header */}
